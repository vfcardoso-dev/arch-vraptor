...
public abstract class AbstractController<T extends AbstractDao, E extends AbstractEntity> {

    private Result result;
    private T dao;

    public AbstractController(Result result, T dao) {
        this.result = result;
        this.dao = dao;
    }
     ...
     */
    public void add(E entity, String textSuccess, IControllerCrud self) {
        try {
            dao.save(entity);
     ...
     * @param self objeto controller instanciado, para fazer o redirecionamento após salvar
     */
    public void add(E entity, String textSuccess, IControllerCrudUpload self) {
        try {
            dao.save(entity);
            ControllerUtils.defineSuccessMessage(result, textSuccess);
            result.redirectTo(self).list();
     ...
     */
    public void update(E entity, String textSuccess, IControllerCrud self) {
        try {
            dao.update(entity);
            ControllerUtils.defineSuccessMessage(result, textSuccess);
            result.redirectTo(self).list();
     ...
     * @param self objeto controller instanciado, para fazer o redirecionamento após atualizar
     */
    public void update(E entity, String textSuccess, IControllerCrudUpload self) {
        try {
            dao.update(entity);
            ControllerUtils.defineSuccessMessage(result, textSuccess);
            result.redirectTo(self).list();
